        ...
        <div class="d-flex">
            ...
            <div class="d-flex flex-column flex-shrink-0 p-3"
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="admin-dashboard-promosi.php" class="nav-link active text-light"
                    ...
                    <li>
                        <a href="admin-dashboard-pendapatan.php" class="nav-link text-light">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th class="align-middle">Pemilik Kost</th>
                            <th class="align-middle">Nama Kost</th>
                            <th class="align-middle">Mulai Promosi</th>
                            <th class="align-middle">Jumlah Pembayaran</th>
                            <th class="align-middle">Waktu</th>
                            <td class="mt-3">
                                <a href="edit-pk.php?id=<?php echo $row['id']; ?>"
                                    class="btn btn-sm btn-primary mt-2 btn-edit"><img src="img2/edit.png" class="w-75">
                                </a>

                                <a href="?delete=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger mt-2 btn-trash"
